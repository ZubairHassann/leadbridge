...
from .views import callrail_records, callrail_webhook, offline_conversions, qualified_calls, shopmonkey_orders
...
urlpatterns = [
    ...
    path("qualified-calls/", qualified_calls, name="qualified_calls"),
]
